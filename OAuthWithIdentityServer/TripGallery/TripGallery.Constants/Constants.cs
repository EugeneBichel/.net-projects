namespace TripGallery
{
    public class Constants
    {
		...
		public const string TripGallryMVC = "https://localhost:44318/";
		public const string TripGalleryMVCSTSCallback = "https://localhost:44318/stscallback";
		public const string TripGalleyAngular = "https://localhost:44316/";
		...
		public const string TripGallerySTSRevokeTokenEndpoint = TripGallerySTS + "/connect/revokation";
    }
}
